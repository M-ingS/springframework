...
<div class="card">
	...
	<div class="card-body">		<!-- submit누르면 action의 경로로 요청을 보냄 -->
			...
			<button type="button" onclick="requestAjax()" class="btn btn-info btn-sm mt-2">요청</button>	<!-- type="button"넣어줘야 submit효과 X -->
		</form>
		...
		<script>
			function requestAjax(){
				...
				var param4 = $("input[name=param4]:checked").val();	//name이 param4인 것들 중에 체크되어 있는 것을 가져옴
				var param5 = $("#param5").val();
				
				const params = {param1:param1, 
								param2, param3, param4, param5};	// 속성명과 변수명이 같으면 하나만 해도 됨
				console.log(params);
