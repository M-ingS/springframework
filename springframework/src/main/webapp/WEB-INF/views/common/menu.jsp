...
<div class="accordion" id="accordionMenu">
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch01'?'':'collapsed'}" type="button"
				...
				aria-expanded="${chNum=='ch01'}" aria-controls="ch01">Ch01. 개발 환경 구축</button>
		</h2>
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button  ${chNum=='ch02'?'':'collapsed'}" type="button"
				...
				Ch02. Controller(RequestMapping)</button>
		</h2>
		<div id="ch02" class="accordion-collapse collapse ${chNum=='ch02'?'show':'' }"
			data-bs-parent="#accordionMenu">
			<div class="accordion-body">
				<ul>
					<li><a
	...
	<div class="accordion-item">
		<h2 class="accordion-header">
			<button class="accordion-button ${chNum=='ch03'?'':'collapsed'}" type="button"
				...
				aria-expanded="${chNum=='ch02'}" aria-controls="ch03">Ch03.Controller(매개변수)</button>
		</h2>
	...
	<div class="accordion-item">
			<h2 class="accordion-header">
				<button class="accordion-button ${chNum=='ch04'?'':'collapsed'}" type="button"
					...
					aria-expanded="${chNum=='ch04'}" aria-controls="ch04">Ch04.Controller(폼 유효성 검사)</button>
			</h2>
			<div id="ch04" class="accordion-collapse collapse ${chNum=='ch04'?'show':''}"
				data-bs-parent="#accordionMenu">
				<div class="accordion-body">
					<ul>
		...
		<div class="accordion-item">
			<h2 class="accordion-header">
				<button class="accordion-button ${chNum=='ch05'?'':'collapsed'}" type="button"
					...
					aria-expanded="${chNum=='ch05'}" aria-controls="ch05">Ch05.Controller(Ch05. 헤더값 및 쿠키 설정)</button>
			</h2>
			<div id="ch05" class="accordion-collapse collapse ${chNum=='ch05'?'show':''}"
				data-bs-parent="#accordionMenu">
				<div class="accordion-body">
					<ul>
		...
		<div class="accordion-item">
			...
			<div id="ch06" class="accordion-collapse collapse ${chNum=='ch06'?'show':''}"
				data-bs-parent="#accordionMenu">
				<div class="accordion-body">
					<ul>
		...
		<div class="accordion-item">
			<h2 class="accordion-header">
				<button class="accordion-button ${chNum=='ch07'?'':'collapsed'}" type="button"
					data-bs-toggle="collapse" data-bs-target="#ch07"
					aria-expanded="${chNum=='ch07'}" aria-controls="ch07">
					Ch07. 데이터 전달 및 데이터(객쳬) 및 데이터 전달
				</button>
			</h2>
			<div id="ch07" class="accordion-collapse collapse ${chNum=='ch07'?'show':''}"
				data-bs-parent="#accordionMenu">
				<div class="accordion-body">
					<ul>
						<li><a href="${pageContext.request.contextPath}/ch07/objectScope1">데이터(객체) 사용범위1</a></li>
						<li><a href="${pageContext.request.contextPath}/ch07/objectScope2">데이터(객체) 사용범위 2</a></li>
		...
		<div class="accordion-item">
			<h2 class="accordion-header">
				<button class="accordion-button ${chNum=='ch08'?'':'collapsed'}" type="button"
					data-bs-toggle="collapse" data-bs-target="#ch08"
					aria-expanded="${chNum=='ch08'}" aria-controls="ch08">
					Ch08. 세션 지원 API
				</button>
			</h2>
			<div id="ch08" class="accordion-collapse collapse ${chNum=='ch08'?'show':''}"
				data-bs-parent="#accordionMenu">
				<div class="accordion-body">
					<ul>
	...
	<div class="accordion-item">
		...
		<div id="ch14"
			...
			<div class="accordion-body">
				<ul>
					<li><a href="${pageContext.request.contextPath}/ch14/before">메소드 호출 전 공통 코드 실행</a></li>
					<li><a href="${pageContext.request.contextPath}/ch14/after">메소드 호출 후 공통 코드 실행</a></li>
