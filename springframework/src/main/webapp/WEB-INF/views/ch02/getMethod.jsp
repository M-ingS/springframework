...
<div class="card">
	...
	<div class="card-body">
		<div>
			<a href="getAtag">링크1</a> <br /> <a href="getAtag?bno=5&bkind=free">링크2</a>
			<br />
			<!-- 쿼리 스트링 -->
		</div>
		...
		<div class="mt-2">
			<button onclick="requestGet1()" class="btn btn-info btn-sm mb-2">JavaScrip: location.href 속성이용</button>
			<br/><br/>
			<button onclick="requestGet2()" class="btn btn-info btn-sm mb-2">JavaScrip: AJAX 이용</button>
			<button onclick="requestGet3()" class="btn btn-info btn-sm mb-2">JavaScrip: AJAX json 이용</button>
