	...
	<div class="card-body">
		...
		<script>
			function uploadFileFromAjax(){
				//multipart/form-data로 구조를 본문을 생성하는 객체
				...
				$.ajax({
					...
					method: "post",
					data: formData,
					cache:false,	// 브라우저 데이터를 메모리에 저장하지X 
					processData: false,	// 요청 HTTP 본문의 내용을 가공처리하지X(QueryString으로 변환X)
					contentType:false, 	// 본문에는 여러 개의 contentType이 존재하므로 1개로 표현을 할 수 없음
